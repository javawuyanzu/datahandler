...
module.exports = {
    text : function(sql,params,callback){

        var RunInfoconnection = mysql.createConnection(RunInfoDB.db);
        RunInfoconnection.query('SELECT col1 as chushuiwendu from RunInfos', function(err, rows) {
            return rows;
    ...
    addRunInfo : function(sql,params,callback){
                ...
                for (var i = 0; i < rows.length; i++) {
                    ...
                    if(rows[i].DeviceNo>0){
                        ...
                        if(typeof(type)!=="undefined"){
                            var data = lib.DeviceAdapterUtil.getSdcSoftDevice(type, new Uint8Array(byte),'zh-cn')
                            //运行信息处理
                            try{
...
var XXXXX_ExceptionInfosJson= function(){
    var xxx={
        "111":"col1",
        "111":"col2",
        "111":"col3",
